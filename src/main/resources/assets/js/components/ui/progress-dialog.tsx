...
import { getProgress, isTerminalState, taskQueryOptions } from '../../lib/api/tasks';
...
export const ProgressDialog = ({
  ...
  const resolvedDescription =
    taskId != null ? task?.progress.info || t('common.progress.starting') : description;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <p className="text-muted-foreground text-center text-sm">{Math.round(resolvedProgress)}%</p>
      </DialogContent>
    </Dialog>
  );
};
