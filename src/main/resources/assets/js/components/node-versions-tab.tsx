          ...
          return (
            <li key={v.versionId}>
              ...
              >
                ...
                <span className="shrink-0 font-mono text-xs">{shortId(v.versionId)}</span>
                {isActive && (
              ...
              {isExpanded && (
                <div className="bg-muted/30 space-y-2 px-4 pt-1 pb-3">
                  <VersionDetailRow label={t('versions.label.version')}>
                    <span className="font-mono text-xs break-all">{v.versionId}</span>
                    <CopyIconButton
                      value={v.versionId}
                  ...
                  <VersionDetailRow label={t('versions.label.committed')}>
                    <span className="font-mono text-xs">{formatFullTimestamp(v.timestamp)}</span>
                  </VersionDetailRow>
                  {v.commit != null && (
                  ...
                  {!isActive && (
                    <div className="flex justify-end pt-1">
                      <Button variant="primary" size="sm" onClick={() => setPendingVersion(v)}>
