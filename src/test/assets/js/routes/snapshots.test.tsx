...
describe('SnapshotsPage', () => {
    it('should render snapshot table with data', async () => {
        mockSnapshotsFetch([
            { name: 'snap-2026-01-01', reason: 'test', timestamp: '2026-01-01T00:00:00Z', state: 'SUCCESS', indices: ['idx1', 'idx2'] },
            { name: 'snap-2026-01-02', reason: 'backup', timestamp: '2026-01-02T12:00:00Z', state: 'SUCCESS', indices: ['idx1'] },
        ]);
    ...
    it('should show create snapshot button', async () => {
        mockSnapshotsFetch([
            { name: 'snap-1', reason: 'test', timestamp: '2026-01-01T00:00:00Z', state: 'SUCCESS', indices: [] },
        ]);
    ...
    it('should display indices count', async () => {
        mockSnapshotsFetch([
            { name: 'snap-1', reason: 'test', timestamp: '2026-01-01T00:00:00Z', state: 'SUCCESS', indices: ['idx1', 'idx2', 'idx3'] },
        ]);
