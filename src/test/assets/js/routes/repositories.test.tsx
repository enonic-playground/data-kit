...
describe('RepositoriesPage', () => {
  ...
  it('should show branch name badges', async () => {
    mockedApiFetch.mockResolvedValue([{ id: 'my-repo', branches: ['master', 'draft', 'test'] }]);
  ...
  it('should show create repository button', async () => {
    mockedApiFetch.mockResolvedValue([{ id: 'test-repo', branches: ['master'] }]);
    ...
    const page = within(getRepoPage());
    expect(page.getByRole('button', { name: /create repository/i })).toBeInTheDocument();
  });
  ...
  it('should validate repository name on create dialog', async () => {
    ...
    const page = within(getRepoPage());
    await user.click(page.getByRole('button', { name: /create repository/i }));
