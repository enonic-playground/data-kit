...
import { delete as deleteHandler, get, post } from '../../main/resources/apis/dumps/dumps';
import {
  createDump,
  deleteDump,
  downloadDump,
...
describe('POST /dumps?action=upload', () => {
  test('uploads a dump successfully', () => {
    const fakeStream = { fake: 'stream' };
    mockedGetMultipartItem.mockReturnValue({
      fileName: 'my-dump.zip',
